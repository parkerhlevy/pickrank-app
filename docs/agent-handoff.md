...
- this machine is currently on `main` at merge commit `496081e Add eligibility foundation (#17)`; generated `next-env.d.ts` typed-route churn remains unstaged noise
