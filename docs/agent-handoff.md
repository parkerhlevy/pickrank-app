...
- source sync for the eligibility branch is current through pushed commit `887dc92 Tighten post-SSO eligibility setup` on `origin/codex/eligibility-foundation`; the earlier foundation commit `c4a3a73 Add eligibility foundation` created READY preview deployment `dpl_577qLXK6q3bhu1Nz2HG96oBLrywv` at `https://pickrank-i72w2wym0-parker-levys-projects.vercel.app`
