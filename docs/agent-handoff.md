...
- this machine is currently on `main`; after the player-pool/board terminology and gameplay usability slice is pushed, local `main` should match `origin/main` with no committed-but-unpushed product work
